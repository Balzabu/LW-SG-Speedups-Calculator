...
function toggleGeneralSpeedups(tabName) {
    ...
    if (button.checked) {
        ...
        var generalSpeedups = [
            ...
            { name: "general_3h", label: "3h Speedup"},
...
function calculate(tabName) {
    ...
    const threeHourInput = form.elements[tabName + '_3h'];
    ...
    totalMinutes += (parseInt(threeHourInput.value) || 0) * 180;
    ...
    if (generalSpeedupsToggle.checked) {
        ...
        const generalSpeedupHoursValues = [1, 3, 8];
